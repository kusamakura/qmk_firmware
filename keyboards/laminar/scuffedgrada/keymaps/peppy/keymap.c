...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_wrapper(
		...
		KC_LGUI, ___LEFT_BASE_ROW3___, ___RGHT_BASE_ROW3___, KC_SCLN, KC_ENT,
	...
	[1] = LAYOUT_wrapper(
		...
		XXXX, ___LEFT_NAV_ROW4___, ___RGHT_NAV_ROW4___, XXXX, XXXX,
	...
	[2] = LAYOUT_wrapper(
		...
		XXXX, ___LEFT_SYM_ROW4___, ___RGHT_SYM_ROW4___, XXXX, XXXX,
		XXXX, XXXX, XXXX, VVVV, XXXX, XXXX, XXXX, XXXX
	),
	...
	[3] = LAYOUT_wrapper(
		...
		XXXX, ___LEFT_NUM_ROW4___, ___RGHT_NUM_ROW4___, XXXX, XXXX,
		XXXX, XXXX, XXXX, VVVV, XXXX, XXXX, XXXX, XXXX
	),
